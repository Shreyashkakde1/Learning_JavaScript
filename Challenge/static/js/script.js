...
function rpsForntEnd(humanImageChoice, botImageChoice, finalMessage) {
  var imageDatabase = {
    ...
    humanDiv.innerHTML=" <img src='"+imageDatabase[humanImageChoice] + "' hight=150px width=150px style='box-shadow: 0px 10px 50px rgba(37,50,233,1);' >"
    messageDiv.innerHTML= "<h1 style='color:"+finalMessage['color'] + "; font-size:60px ; padding: 30px; '> "+ finalMessage['message'] + "</h1>"
    botDiv.innerHTML=" <img src='"+imageDatabase[botImageChoice] + "' hight=150px width=150px style='box-shadow: 0px 10px 50px rgba(243,38,24,1);' >"
